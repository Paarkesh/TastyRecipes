...
class _IngredientScreenState extends State<IngredientScreen> {
                        ...
                        Column(
                          children: [
                            const Padding(
                              ...
                              child: Text(
                                  "Do you want to check out the full recipe? Click the link below"),
                            ),
                            Row(
                                mainAxisAlignment:
                                ...
                                children: [
                                  ...
                                  FloatingActionButton(
                                    ...
                                    onPressed: () {
                                      Share.share(
                                          'Hey! Check out ${widget.recipe.label} for ${widget.recipe.mealType.join(", ")}!\n\n${widget.recipe.url}');
                                    },
                                    child: const Icon(
                                      Icons.share,
                                      color: Colors.amber,
  ...
  void launchURL(String url) async => await launchUrlString(url);
